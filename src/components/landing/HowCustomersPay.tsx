  ...
  return (
    <section ref={sectionRef} className="py-32 bg-gradient-to-b from-white via-[#FAFAFA] to-white relative overflow-hidden">
      ...
      <motion.div style={{ y }} className="absolute top-20 right-10 hidden lg:block">
        <div className="w-64 h-64 rounded-full bg-gradient-to-br from-purple-200/40 to-blue-200/40" style={{ filter: 'blur(80px)' }} />
      </motion.div>
      <motion.div style={{ y: useTransform(scrollYProgress, [0, 1], [-30, 30]) }} className="absolute bottom-20 left-10 hidden lg:block">
        <div className="w-48 h-48 rounded-full bg-gradient-to-br from-indigo-200/30 to-purple-200/30" style={{ filter: 'blur(60px)' }} />
      </motion.div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div
            ...
            className="inline-block mb-4 px-4 py-2 bg-gradient-to-r from-purple-100 to-blue-100 rounded-full"
          >
                ...
                {[1, 2, 3, 4].map((num) => (
                  ...
                  >
                    <div className="relative mb-3">
                      <div className={`w-full h-3 rounded-full ${num === 1 ? 'bg-gradient-to-r from-purple-500 to-indigo-600' : 'bg-gray-200'} shadow-sm`} />
                      {num === 1 && (
                        <motion.div
                          className="absolute inset-0 bg-gradient-to-r from-purple-400 to-indigo-500 rounded-full"
